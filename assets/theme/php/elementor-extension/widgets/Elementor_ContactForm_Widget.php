        ...
        $html = sprintf(
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form class="php-email-form aos-init aos-animate" role="form" action="forms/contact.php" method="post" data-aos="fade-up">
                            
                            <div class="form-row">
                            
                                <div class="col-md-6 form-group">
                                    <input id="name" class="form-control" name="name" type="text" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                            ...
                            <div class="form-group">
                                <input id="subject" class="form-control" name="subject" type="text" placeholder="Subject" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validate">&nbsp;</div>
                            </div>
